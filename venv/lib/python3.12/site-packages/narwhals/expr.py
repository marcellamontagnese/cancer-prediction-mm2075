...
class Expr:
    ...
    def sort(self, *, descending: bool = False, nulls_last: bool = False) -> Self:
        ...
        """
        return self.__class__(
            lambda plx: self._call(plx).sort(
    ...
    def clip(
        ...
        """
        return self.__class__(
            lambda plx: self._call(plx).clip(lower_bound, upper_bound)
        )
...
class ExprStringNamespace(Generic[ExprT]):
    ...
    def to_uppercase(self: Self) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).str.to_uppercase()
        )
    ...
    def to_lowercase(self: Self) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).str.to_lowercase()
        )
...
class ExprDateTimeNamespace(Generic[ExprT]):
    ...
    def total_minutes(self: Self) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).dt.total_minutes()
        )
    ...
    def total_seconds(self: Self) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).dt.total_seconds()
        )
...
class ExprNameNamespace(Generic[ExprT]):
    ...
    def map(self: Self, function: Callable[[str], str]) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).name.map(function)
        )
    ...
    def prefix(self: Self, prefix: str) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).name.prefix(prefix)
        )
    ...
    def suffix(self: Self, suffix: str) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).name.suffix(suffix)
        )
    ...
    def to_lowercase(self: Self) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).name.to_lowercase()
        )
    ...
    def to_uppercase(self: Self) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._call(plx).name.to_uppercase()
        )
...
class Then(Expr):
    ...
    def otherwise(self, value: Any) -> Expr:
        return Expr(
            lambda plx: self._call(plx).otherwise(extract_compliant(plx, value))
        )
